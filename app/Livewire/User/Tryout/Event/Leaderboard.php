...
class Leaderboard extends Component
{
    ...
    public function render()
    {
        ...
        $packageTryout = Package_member::where('tryout_id', $this->tryoutId)->first();

        return view('livewire.user.tryout.event.leaderboard', [
            'categories' => $categories,
            'firstFilters' => $filterFirst,
            'secondFilters' => $filterSecond,
            'package' => $packageTryout,
