    ...
    public function store(StoreBimbelRequest $request)
    {
        ...
        try{
            ...
            if(Gate::allows('admin')){
                ...
                return redirect()->route('mentor.bimbel.index')->with('success', 'bimbel Update successfully.');
            }
        } catch (\Exception $e) {
    ...
    public function destroy(Bimbel $bimbel)
    {
        ...
        try{
            ...
            if(Gate::allows('admin')){
                ...
                return redirect()->route('mentor.bimbel.index')->with('success', 'Bimbel deleted successfully.');
            }
        } catch (\Exception $e) {
