    ...
    <style>
       /* Custom Style for DataTable */
        .dataTables_wrapper .dataTables_filter input {
            @apply border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 my-3;
        }

        .dataTables_wrapper .dataTables_paginate .paginate_button {
            @apply border border-gray-300 rounded-md px-3 py-1 hover:bg-gray-200;
        }
        ...
        .dataTables_wrapper .dataTables_length select {
            @apply border-0 border-gray-300 rounded-lg px-3 py-2 my-3;
        }
        ...
        <div class="w-full mb-1">
                ...
                <div class="bg-gradient-to-tr from-sky-400 to-sky-500 rounded-lg shadow-lg py-4 px-3">
                    <nav class="flex" aria-label="Breadcrumb">
                        ...
                        <li>
                            ...
                            <a href="#" class="ml-1 text-gray-50 hover:text-sky-200 md:ml-2 dark:text-gray-300 dark:hover:text-white">Users</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
            ...
            <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700 mb-4">
                ...
                <div class="flex justify-center items-center gap-2">
                    <div class="">
                        <x-select-input id="user_role_filter" class="p-2 border rounded">
                ...
                <div class="">
                    <div class="align-middle">
                        <div class=" overflow-x-scroll lg:overflow-x-hidden">
                            <table id="userTable" class="w-full divide-y divide-gray-200 whitespace-nowrap dark:divide-gray-600">
                                <thead class="bg-gray-100 dark:bg-gray-700">
                                    <tr>
                                        <th scope="col" class="p-4">
                                            <div class="flex items-center">
                                                <input id="checkbox-all" type="checkbox" class="w-4 h-4 text-sky-400 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
