            ...
            <div class="space-y-4">
                ...
                {{-- <div>
                    ...
                    <select id="categories" name="categories" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <option value="Tes Potensi Skolastik" {{ $tryout->categories == 'Tes Potensi Skolastik' ? 'selected' : '' }}>Tes Potensi Skolastik</option>
                        <option value="Tes Literasi" {{ $tryout->categories == 'Tes Literasi' ? 'selected' : '' }}>Tes Literasi</option>
                    </select>
                </div> --}}
                <div>
                ...
                <div>
                    ...
                    <select id="batch_id" name="batch_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        @foreach ($batch as $batchs)
                            <option value="{{ $batchs->id }}" {{$tryout->batch->id == $batchs->id ? 'selected' : '' }} >{{ $batchs->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div>
                ...
                <div id="date-inputs" style="display: none;"> 
                    <div>
                        ...
                        <input type="date" name="start_date" value="{{$tryout->start_date}}" id="start_date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Type product start_date" required="">
                    </div>
                    <div>
                        <label for="end_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">end_date</label>
                        <input type="date" name="end_date" value="{{$tryout->end_date}}" id="end_date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Type product end_date" required="">
                    </div>
                </div>
