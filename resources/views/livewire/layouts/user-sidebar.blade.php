      ...
      <div class="flex-1 px-3 space-y-1 rounded-lg bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
        <ul class="pb-2 space-y-2">
          ...
          <li>
            ...
            <x-user-sidebar-link link="{{ route('user.dashboard') }}" token="dashboard" name="Dashboard">
          ...
          {{-- <li>
            ...
            <x-sidebar-dropdown id="dropdown-tryout" name="Tryout">
              ...
              <x-slot name="content">
                <li>
                  <a href="{{route('user.tryouts')}}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700  dark:bg-gray-700 ">All</a>
                </li>
                <li>
                  <a href="{{route('user.tryouts.owned')}}" class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 dark:bg-gray-700 ">Owned</a>
                </li>
              </x-slot>
            </x-sidebar-dropdown>
          </li>
          <li>
            <x-sidebar-dropdown id="dropdown-bimbel" name="Bimbel">
