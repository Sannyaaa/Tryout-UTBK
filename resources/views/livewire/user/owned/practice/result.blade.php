                    ...
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 text-sm font-semibold md:space-x-2">
                            ...
                            <li>
                                ...
                                <a href="#" class="ml-1 text-gray-50 hover:text-sky-200 md:ml-2 dark:text-gray-300 dark:hover:text-white">{{ $result->class_bimbel->name }}</a>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center">
                                <svg class="w-6 h-6 text-gray-50" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                                <span class="ml-1 text-gray-50 md:ml-2 dark:text-gray-500" aria-current="page">Latihan</span>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center">
                                ...
                                <div class="relative flex items-start p-4 rounded-lg border 
                                    ...
                                    <div class="ml-4 flex items-center justify-between w-full">
                                        <span class="font-medium {{ $option === $question->correct_answer ? 'text-sky-700' : 
                                                                ...
                                                                'text-gray-900') }}">
                                            {{strtoupper($option)}}. {{$question->answer_practice->$option}}
                                        </span>
