                ...
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 text-sm font-semibold md:space-x-2">
                        ...
                        <li>
                            <div class="flex items-center">
                            <svg class="w-6 h-6 text-gray-50" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <span class="ml-1 text-gray-50 md:ml-2 dark:text-gray-500" aria-current="page">Persiapan Latihan</span>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        <div class="w-full lg:flex justify-center items-center">
            ...
            <div class="bg-white flex w-fit rounded-md shadow-lg px-16 py-6">
                <div class="my-auto space-y-6">
                    <h1 class="text-5xl capitalize font-bold text-sky-500">Latihan {{ $class_bimbel->name }}</h1>
                    <div class="text-gray-600 font-semibold">
                        <h2 class="text-xl font-seibold mb-1 text-gray-800">Informasi Latihan</h2>
                        <div class="space-y-1">
                            <table class="w-full max-w-xl">
                                <tr class="w-full grid grid-cols-2">
                                    ...
                                    <td>
                                        <span class="">: {{ $class_bimbel->sub_categories->name }}</span>
                                    </td>
                                </tr>
                                <tr class="w-full grid grid-cols-2">
                                    <td>
                                    ...
                                    <td>
                                        <span class="">: {{ $class_bimbel->totalQuestion }} Pertanyaan</span>
                                    </td>
                                </tr>
                                <tr class="w-full grid grid-cols-2">
                                    <td>
                                    ...
                                    <td>
                                        <span class="">: {{ $class_bimbel->duration ?? '-' }} Menit</span>
                                    </td>
                                </tr>
                                <tr class="w-full grid grid-cols-2">
                                    <td>
                                    ...
                                    <td>
                                        <span class="">: {{ $class_bimbel->avgScore ? round($class_bimbel->avgScore,1) : 0 }} Poin</span>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="text-gray-600 font-semibold">
                        ...
                        @if ($class_bimbel->totalQuestion == 0)
                    ...
                    <div class="gap-5 flex">
                        <x-secondary-link href="{{ route('user.my-bimbel', $class_bimbel->bimbel_id) }}">
                            Kembali
                        </x-secondary-link>
                        @if ($class_bimbel->totalQuestion != null)
                            <x-primary-link href="{{ route('user.my-bimbel.paper', $class_bimbel->id) }}" class="">
                                Mulai Latihan
                            </x-primary-link>
                        @endif
                    </div>
