            ...
            <div class="bg-gradient-to-tr from-sky-400 to-sky-500 rounded-lg shadow-lg py-4 px-3">
                <nav class="flex" aria-label="Breadcrumb">
                    ...
                    <li>
                        <div class="flex items-center">
                        <svg class="w-6 h-6 text-gray-50" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                        <span class="ml-1 text-gray-50 md:ml-2 dark:text-gray-500" aria-current="page">{{ $classBimbel->bimbel->name }}</span>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-8">
                ...
                <div class="py-8 px-10" style="width: 100%;">
                    <div class="flex justify-between items-center">
                        ...
                        <div>
                            <x-secondary-link href="{{ route('user.my-bimbel.practice.history', $classBimbel->id) }}">
                                Kembali
                            </x-secondary-link>
                        </div>
                    </div>
                    ...
                    <div class="w-full flex justify-between mt-12">
                        <div class="">
                            <h3 class="text-lg font-semibold text-gray-800 mb-3">Urutan Hasil Tryout</h3>
                            <div class="p-5 bg-sky-50 rounded-lg text-sky-500 font-semibold text-center">
                                <div class="">Hasil Ini Berada di Urutan ke
                                    <h2 class="font-extrabold text-6xl my-3">{{ $userRank }}</h2>
                                </div>
                                <div class="">Dari {{ $allResults->count() }} Hasil.</div>
                            </div>
                        </div>
                        <div class="">
