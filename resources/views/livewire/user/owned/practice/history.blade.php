            ...
            <div class="mx-6">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <div class="inline-flex gap-3">
                        ...
                        <x-primary-link href="{{ route('user.my-bimbel.paper', $classBimbel->id) }}" target="__blank" class="flex items-center gap-2">
                                        ...
                                        @forelse($results as $item)
                                            <tr>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    {{ $item->class_bimbel->bimbel->name }}
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    {{ $item->class_bimbel->name }}
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    {{ $item->score }}
                                                </td>
