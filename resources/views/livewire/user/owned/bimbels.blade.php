                ...
                <div class="flex justify-between items-center mb-2">
                    ...
                    <div>
                        <x-primary-link href="{{ $bimbel->link_group }}" target="__blank" class="flex items-center gap-2">
                            ...
                            <span class="text-xl">Gabung Group</span>
                        </x-primary-link>
                    </div>
                </div>
                <div class="">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 text-gray-700 text-sm">
                                    @forelse($queryClass as $class)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <a href="{{ $class->link_video }}" target="_blank" class="text-sky-500 hover:text-sky-600 gap-1 bg-sky-50 bg-opacity-50 px-4 py-2 border-2 border-sky-200 rounded-lg">
