<div>
    <div class="px-4 pt-6">
        ...
        <div class="grid col-span-1 md:grid-cols-2 lg:grid-cols-4 my-6 gap-6">
            ...
            <div class="">
                ...
                <div class="flex-auto p-4">
                    ...
                    <div class="flex-none w-2/3 max-w-full px-3">
                        <div>
                        <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase text-gray-500 dark:text-white dark:opacity-60">Paket Perbelian</p>
        ...
        <div class="grid gap-6 grid-cols-1">
            @if ($queryClass->isNotEmpty())
                <div>
                    <!-- Main widget -->
                    <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-lg dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                        <div class="mb-2 flex justify-between items-center">
                            <h1 class="text-2xl font-semibold text-gray-600 sm:text-3xl sm:leading-none sm:tracking-tight dark:text-white mb-3">Daftar Kelas Akan Datang</h1>
                        </div>
                            <!-- Table -->
                        <!-- Table -->
