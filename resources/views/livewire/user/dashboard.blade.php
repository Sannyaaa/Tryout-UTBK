    ...
    <div class="px-4 pt-6">
                    ...
                    @if ($todayClasses)
                        @foreach ($todayClasses as $class)
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <div class="w-full h-full flex justify-center items-center bg-gradient-to-tr from-sky-400 to-sky-500 text-white">
                                    <div class="w-4/5 flex justify-between items-center">
                                        <div>
                                            <h2 class="font-extrabold text-3xl lg:text-4xl">Pemberitahuan Kelas Bimbel</h2>
                                            <h3 class="font-semibold text-xl mt-2">Hari ini kamu ada kelas dengan informasi sebagai berikut:</h3>
                                            <div class="ms-3 mt-2">
                                        ...
                                        <div class="hidden md:flex items-center justify-center mt-2">
                                            <img src="{{ asset('assets/Webinar-pana.png') }}" class=" h-96" alt="...">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                <div class="w-full h-full flex justify-center items-center bg-gradient-to-tr from-sky-400 to-sky-500 text-white">
                                    <div class="w-4/5 flex justify-between items-center">
                                        <div>
                                            <div>
                                                <h2 class="font-extrabold text-3xl lg:text-4xl">Pemberitahuan Tryout Event</h2>
                                                <h3 class="font-semibold text-xl mt-2">Kami sedang mengadakan Tryout Event 
                                                    <br>
                                                    mulai tanggal <span class="font-extrabold">{{ date('d F Y', strtotime($item->start_date)) }}</span> sampai <span class="font-extrabold">{{ date('d F Y', strtotime($item->end_date)) }}.</span>
                                                    <br>
                                        ...
                                        <div class="hidden md:flex items-center justify-center mt-2">
                                            <img src="{{ asset('assets/Online test-amico.png') }}" class=" h-72" alt="...">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="grid col-span-1 md:grid-cols-2 lg:grid-cols-4 my-6 gap-6">
                ...
                <div class="flex-auto p-4">
                    ...
                    <div class="flex-none w-2/3 max-w-full px-3">
                        <div>
                            ...
                            <h5 class="mb-2 font-semibold text-slate-700 text-lg dark:text-white">{{ $totalMyPackages->count() ?? '0' }} Paket</h5>
            ...
            <div class="">
                ...
                <div class="flex-auto p-4">
                    ...
                    <div class="flex-none w-2/3 max-w-full px-3">
                        ...
                        <h5 class="mb-2 font-semibold text-slate-700 text-lg dark:text-white">{{ $totalBimbels->count() ?? '0' }} Bimbel</h5>
            ...
            <div class="">
                ...
                <div class="flex-auto p-4">
                    ...
                    <div class="flex-none w-2/3 max-w-full px-3">
                        <div>
                            <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase text-gray-500 dark:text-white dark:opacity-60">Tryout Event</p>
                            <h5 class="mb-2 font-semibold text-slate-700 text-lg dark:text-white">{{ $totalEvents->count() ?? '0' }} Tryout Berlangsung</h5>
                            {{-- <p class="mb-0 dark:text-white dark:opacity-60">
            ...
            <div class="">
                ...
                <div class="flex-auto p-4">
                    ...
                    <div class="flex-none w-2/3 max-w-full px-3">
                        <div>
                        <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase text-gray-500 dark:text-white dark:opacity-60">Paket Tersedia</p>
                        <h5 class="mb-2 font-semibold text-slate-700 text-lg dark:text-white">{{ $totalPackages->count() ?? '0' }} Tersedia</h5>
                        {{-- <p class="mb-0 dark:text-white dark:opacity-60">
        ...
        <div class="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3">
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                <h3 class="flex items-center text-lg font-semibold text-gray-900 dark:text-white">Leaderboard
                ...
                @if ($latestTryoutId != null && $firstFilters->isNotEmpty())
                    <div class="">
                        <p class="text-sm text-gray-600">Lihat daftar user yang sudah menyelesaikan ujian ini.</p>
                        ...
                        <div id="fullWidthTabContent" class="border-t border-gray-200 dark:border-gray-600">
                            <div class="hidden pt-4" id="faq" role="tabpanel" aria-labelledby="faq-tab">
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-slate-50 text-slate-600 text-left text-xs uppercase tracking-wider font-semibold">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200 text-gray-700 text-sm">
                                        @forelse($firstFilters as $i => $item)
                                            <tr class="{{ Auth::id() == $item->user_id ? ' text-sky-600 font-semibold' : '' }}">
                                        ...
                                        @endforelse
                                            <tr>
                                                <td colspan="5" class="font-semibold text-base text-slate-800 py-2">
                                                    Peringkatmu Saat Ini
                                                </td>
                                            </tr>
                                           <tr class="{{ Auth::id() == $firstRank['user_id'] ? 'bg-sky-100 text-sky-600 font-semibold' : '' }} rounded-lg overflow-hidden">
                            ...
                            <div class="hidden pt-4" id="about" role="tabpanel" aria-labelledby="about-tab">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200 text-gray-700 text-sm">
                                        ...
                                        @endforelse
                                        {{-- @dd($secondRank) --}}
                                            <tr class="{{ Auth::id() == $secondRank['user_id'] ? ' text-sky-600 font-semibold' : '' }}">
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    {{ $secondRank['rank'] }}
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    {{ $secondRank['user_name'] }}
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    {{ $secondRank['total_score'] }}
                                                </td>
                                            </tr>
                                    </tbody>
                                </table>
