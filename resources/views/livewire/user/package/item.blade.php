                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                                    Untuk melanjutkan proses checkout dan memastikan pesanan Anda tercatat dengan benar, silakan login terlebih dahulu agar kami dapat menghubungkan pesanan ini dengan akun Anda.
                                                </p>
                                            </div>
                                            <!-- Modal footer -->
