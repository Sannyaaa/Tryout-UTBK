...
<aside id="sidebar" class="fixed top-0 left-0 z-50 flex flex-col flex-shrink-0 hidden w-80 p-4 h-full font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
