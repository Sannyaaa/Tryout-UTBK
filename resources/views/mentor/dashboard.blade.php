        ...
        <div class="grid gap-4 xl:grid-cols-2 2xl:grid-cols-4">
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                ...
                <div class="p-6 dark:bg-gray-800">
                        <div class="mb-4">
                            <h1 class="text-lg font-extrabold text-gray-900 sm:text-2xl dark:text-white">Hi, {{ Auth::user()->name }} 🎉</h1>
                            <p class="mt-2 text-sm font-light text-gray-500 dark:text-gray-400">
                                Selamat datang, mentor yang hebat! Ingatlah, ada Class yang akan segera dimulai. 
                                Pastikan semua persiapan sudah selesai agar Class berjalan lancar dan para peserta mendapat pengalaman terbaik.
                            </p>
                        </div>
            ...
            <!--Tabs widget -->
            <div class="p-4 bg-white border border-gray-200 rounded-lg 2xl:col-span-2 shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                <div class="mt-6">
                    <h2 class="mb-0 font-sans text-sm font-semibold leading-normal uppercase text-gray-500 dark:text-white dark:opacity-60">Classes Today</h2>
                    @if ($classesToday->isEmpty())
                        <p class="mt-2 mb-0 font-sans text-sm font-semibold leading-normal uppercase text-gray-500 dark:text-white dark:opacity-60">Tidak ada kelas untuk hari ini.</p>
                    @else
                        <ul class="mt-4 space-y-3">
                            @foreach ($classesToday as $class)
                                <li class="p-4 border border-gray-200 rounded-lg shadow-md dark:border-gray-700">
                                    <div class="flex justify-between">
                                        <div>
                                            <h3 class="text-sm font-bold text-gray-900 dark:text-white">{{ $class->name }}</h3>
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                                Date: {{ \Carbon\Carbon::parse($class->date)->format('d M Y') }} <br>
                                                Time: {{ \Carbon\Carbon::parse($class->start_time)->format('h:i A') }}
                                            </p>
                                        </div>
                                        <div>
                                            <a href="{{ route('mentor.class-bimbel.show', $class->id) }}" 
                                            class="px-3 py-2 text-sm font-medium text-white bg-gradient-to-tl from-sky-400 to-sky-500 rounded-lg">
                                                View Class
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="mt-8">
                    <h2 class="mb-0 font-sans text-sm font-semibold leading-normal uppercase text-gray-500 dark:text-white dark:opacity-60">Upcoming Classes</h2>
                    @if ($upcomingClasses->isEmpty())
                        <p class="mt-2 mb-0 font-sans text-sm font-semibold leading-normal uppercase text-gray-500 dark:text-white dark:opacity-60">Tidak ada kelas yang akan datang.</p>
                    @else
                        <ul class="mt-4 space-y-3">
        ...
        <div class="mt-4">
            <div class="bg-white rounded-lg shadow-md p-4">
                <div class="flex flex-col mt-6">
                    <div class="mb-3">
                        <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase text-gray-500 dark:text-white dark:opacity-60">Daftar Kelas</p>
                    </div>
                    <div class="overflow-x-auto rounded-lg">
                    <div class="inline-block min-w-full align-middle">
                        <div class="overflow-hidden shadow sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                            <thead class="bg-gradient-to-tl from-sky-400 to-sky-500 dark:bg-gray-700">
                            <tr>
                                <th scope="col" class="p-4 text-xs font-medium tracking-wider text-left text-white uppercase dark:text-white">
                                Nama Kelas
                                </th>
                                <th scope="col" class="p-4 text-xs font-medium tracking-wider text-left text-white uppercase dark:text-white">
                                Tanggal
        ...
        <div class="grid col-span-1 md:grid-cols-2 lg:grid-cols-4 my-6 gap-6">
                ...
                <div class="flex-auto p-4">
                    ...
                    <div class="flex-none w-2/3 max-w-full px-3">
                        <div>
                            ...
                            <h5 class="mb-2 font-semibold text-slate-700 text-lg dark:text-white">{{ $bimbel }} </h5>
            ...
            <div class="">
                ...
                <div class="flex-auto p-4">
                    ...
                    <div class="flex-none w-2/3 max-w-full px-3">
                        <div>
                            <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase text-gray-500 dark:text-white dark:opacity-60">Total Class</p>
                            <h5 class="mb-2 font-semibold text-slate-700 text-lg dark:text-white">{{ number_format($classes) }} Class</h5>
            ...
            <div class="">
                ...
                <div class="flex-auto p-4">
                    ...
                    <div class="flex-none w-2/3 max-w-full px-3">
                        <div>
                        <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase text-gray-500 dark:text-white dark:opacity-60">Total Peserta Bimbel</p>
                        <h5 class="mb-2 font-semibold text-slate-700 text-lg dark:text-white">{{ $users }} </h5>
                        {{-- <p class="mb-0 dark:text-white dark:opacity-60">
