...
<div class="p-4 mt-12">
    <div class="p-6 bg-white block rounded-lg shadow sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
        ...
        {{-- <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
            ...
            <form action="{{ route('mentor.class-bimbel.update',$classBimbel->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between">
                        <x-secondary-href href="{{ $back ?? route('mentor.class-bimbel.index') }}">
                            Kembali
                        </x-secondary-href>
