    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->after('password', function ($table){
                ...
                $table->foreign('data_universitas_id')->references('id')->on('data_universitas')->onDelete('cascade');

                $table->unsignedBigInteger('second_data_universitas_id')->nullable();
                $table->foreign('second_data_universitas_id')->references('id')->on('data_universitas')->onDelete('cascade');
